INSERT INTO `courses` (`course_id`, `course_name`, `class_name`, `credits`) VALUES ('C101', '高等数学', '计算机科学2班', 4);
INSERT INTO `courses` (`course_id`, `course_name`, `class_name`, `credits`) VALUES ('C102', '计算机基础', '计算机科学1班', 3);
INSERT INTO `courses` (`course_id`, `course_name`, `class_name`, `credits`) VALUES ('C103', '数据结构', '计算机科学2班', 3);
INSERT INTO `courses` (`course_id`, `course_name`, `class_name`, `credits`) VALUES ('C104', '人工智能导论', '计算机科学1班', 2);
INSERT INTO `courses` (`course_id`, `course_name`, `class_name`, `credits`) VALUES ('C105', '操作系统', '计算机科学1班', 3);
INSERT INTO `courses` (`course_id`, `course_name`, `class_name`, `credits`) VALUES ('C106', 'Java', '计算机科学1班', 4);
INSERT INTO `courses` (`course_id`, `course_name`, `class_name`, `credits`) VALUES ('CS104', '计算机网络', '计算机科学1班', 3);
INSERT INTO `courses` (`course_id`, `course_name`, `class_name`, `credits`) VALUES ('CS105', '数据库系统', '计算机科学2班', 3);
INSERT INTO `courses` (`course_id`, `course_name`, `class_name`, `credits`) VALUES ('CS106', '软件工程', '计算机科学2班', 3);
INSERT INTO `courses` (`course_id`, `course_name`, `class_name`, `credits`) VALUES ('CS107', '人工智能基础', '计算机科学1班', 3);
INSERT INTO `courses` (`course_id`, `course_name`, `class_name`, `credits`) VALUES ('CS108', '机器学习导论', '计算机科学1班', 4);
INSERT INTO `courses` (`course_id`, `course_name`, `class_name`, `credits`) VALUES ('CS109', '深度学习', '计算机科学2班', 4);
INSERT INTO `courses` (`course_id`, `course_name`, `class_name`, `credits`) VALUES ('CS110', '区块链技术', '计算机科学1班', 1);
